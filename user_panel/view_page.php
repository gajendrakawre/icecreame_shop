...
<head>
    ...
    <title>the Blue Summer - View Page</title> 
</head>
<body>
<header class="header">
    <section class="flex">
...
<section class="view_page">
    ...
    ?>
                <form action="" method="post" class="box">
                    <div class="img-box">
                        <img src="../uploaded_image/<?= htmlspecialchars($fetch_products['image']); ?>" alt="<?= htmlspecialchars($fetch_products['name']); ?>">
                    </div>
                    <div class="detail">
                        ...
                        <div class="button">
                            ...
                            <input type="hidden" name="qty" value="1" min="0" class="qty">
...
<div class="products">
    ...
    <div class="box-container">
        <?php
        $select_products = $conn->prepare("SELECT * FROM `products` WHERE status = ? ORDER BY RAND() LIMIT 6");
